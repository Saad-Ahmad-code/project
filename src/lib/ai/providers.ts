...
export const providers: AiProvider[] = [
  // Local open-source LLM (Ollama) first: free, unlimited, offline, and
  // responds in milliseconds. When Ollama is not running, the call fails
  // instantly (connection refused) and the chain falls through to the cloud
  // providers below — so putting it first is safe everywhere.
  { name: "ollama", baseURL: "http://localhost:11434/v1", model: "llama3.2:3b", apiKeyEnv: "OLLAMA_URL", priority: 1 },
  { name: "openrouter-gemma4", baseURL: "https://openrouter.ai/api/v1", model: "google/gemma-4-26b-a4b-it:free", apiKeyEnv: "OPENROUTER_API_KEY", priority: 2 },
